...
# Generated 2012-06-07 10:42:17.134061 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('20120607104216:dd616944')
...
STD_ANON.New = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'New', tag=u'New')
STD_ANON.Existing = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'Existing', tag=u'Existing')
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON_2._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(127L))
...
class STD_ANON_5 (pyxb.binding.datatypes.int):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON_5._CF_totalDigits = pyxb.binding.facets.CF_totalDigits(value=pyxb.binding.datatypes.positiveInteger(5L))
...
# Atomic SimpleTypeDefinition
class STD_ANON_6 (emailType):

    """An atomic simple type."""

    _ExpandedName = None
    _Documentation = None
STD_ANON_6._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(100L))
...
class STD_ANON_7 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON_7._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(17L))
...
STD_ANON_9.CNC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'CNC', tag=u'CNC')
STD_ANON_9.DIG = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'DIG', tag=u'DIG')
STD_ANON_9.PHY = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'PHY', tag=u'PHY')
STD_ANON_9.SVC = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'SVC', tag=u'SVC')
STD_ANON_9.TBD = STD_ANON_9._CF_enumeration.addEnumeration(unicode_value=u'TBD', tag=u'TBD')
...
STD_ANON_11._CF_pattern.addPattern(pattern=u'(\\d{5})?\\d{4}')
...
STD_ANON_12.Own = STD_ANON_12._CF_enumeration.addEnumeration(unicode_value=u'Own', tag=u'Own')
STD_ANON_12.Rent = STD_ANON_12._CF_enumeration.addEnumeration(unicode_value=u'Rent', tag=u'Rent')
STD_ANON_12.Other = STD_ANON_12._CF_enumeration.addEnumeration(unicode_value=u'Other', tag=u'Other')
...
class STD_ANON_13 (pyxb.binding.datatypes.int):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON_13._CF_totalDigits = pyxb.binding.facets.CF_totalDigits(value=pyxb.binding.datatypes.positiveInteger(8L))
...
class CTD_ANON (transactionTypeWithReportGroup):
    ...
    __tokenResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), 'tokenResponse', '__httpwww_litle_comschema_CTD_ANON_httpwww_litle_comschematokenResponse', False)
    ...
    __postDate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'postDate'), 'postDate', '__httpwww_litle_comschema_CTD_ANON_httpwww_litle_comschemapostDate', False)
    ...
    __response = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'response'), 'response', '__httpwww_litle_comschema_CTD_ANON_httpwww_litle_comschemaresponse', False)
    ...
    __responseTime = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'responseTime'), 'responseTime', '__httpwww_litle_comschema_CTD_ANON_httpwww_litle_comschemaresponseTime', False)
    ...
    __message = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'message'), 'message', '__httpwww_litle_comschema_CTD_ANON_httpwww_litle_comschemamessage', False)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __itemDiscountAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'itemDiscountAmount'), 'itemDiscountAmount', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaitemDiscountAmount', False)
    ...
    __quantity = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'quantity'), 'quantity', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaquantity', False)
    ...
    __detailTax = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'detailTax'), 'detailTax', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemadetailTax', True)
    ...
    __unitCost = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'unitCost'), 'unitCost', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaunitCost', False)
    ...
    __taxAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxAmount'), 'taxAmount', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemataxAmount', False)
    ...
    __commodityCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'commodityCode'), 'commodityCode', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemacommodityCode', False)
    ...
    __itemSequenceNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'itemSequenceNumber'), 'itemSequenceNumber', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaitemSequenceNumber', False)
    ...
    __lineItemTotal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotal'), 'lineItemTotal', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemalineItemTotal', False)
    ...
    __itemDescription = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'itemDescription'), 'itemDescription', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaitemDescription', False)
    ...
    __lineItemTotalWithTax = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotalWithTax'), 'lineItemTotalWithTax', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemalineItemTotalWithTax', False)
    ...
    __productCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'productCode'), 'productCode', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaproductCode', False)
    ...
    __unitOfMeasure = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'unitOfMeasure'), 'unitOfMeasure', '__httpwww_litle_comschema_CTD_ANON_2_httpwww_litle_comschemaunitOfMeasure', False)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __invoiceReferenceNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'invoiceReferenceNumber'), 'invoiceReferenceNumber', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemainvoiceReferenceNumber', False)
    ...
    __shippingAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'shippingAmount'), 'shippingAmount', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemashippingAmount', False)
    ...
    __orderDate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'orderDate'), 'orderDate', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemaorderDate', False)
    ...
    __dutyAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'dutyAmount'), 'dutyAmount', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadutyAmount', False)
    ...
    __lineItemData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'lineItemData'), 'lineItemData', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemalineItemData', True)
    ...
    __deliveryType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'deliveryType'), 'deliveryType', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadeliveryType', False)
    ...
    __customerReference = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerReference'), 'customerReference', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemacustomerReference', False)
    ...
    __destinationPostalCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'destinationPostalCode'), 'destinationPostalCode', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadestinationPostalCode', False)
    ...
    __shipFromPostalCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'shipFromPostalCode'), 'shipFromPostalCode', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemashipFromPostalCode', False)
    ...
    __taxExempt = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxExempt'), 'taxExempt', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemataxExempt', False)
    ...
    __salesTax = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'salesTax'), 'salesTax', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemasalesTax', False)
    ...
    __destinationCountryCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'destinationCountryCode'), 'destinationCountryCode', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadestinationCountryCode', False)
    ...
    __discountAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'discountAmount'), 'discountAmount', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadiscountAmount', False)
    ...
    # Element {http://www.litle.com/schema}detailTax uses Python identifier detailTax
    __detailTax = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'detailTax'), 'detailTax', '__httpwww_litle_comschema_CTD_ANON_3_httpwww_litle_comschemadetailTax', True)
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'password'), 'password', '__httpwww_litle_comschema_CTD_ANON_5_httpwww_litle_comschemapassword', False)
    ...
    __user = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'user'), 'user', '__httpwww_litle_comschema_CTD_ANON_5_httpwww_litle_comschemauser', False)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __authAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authAmount'), 'authAmount', '__httpwww_litle_comschema_CTD_ANON_6_httpwww_litle_comschemaauthAmount', False)
    ...
    __authDate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authDate'), 'authDate', '__httpwww_litle_comschema_CTD_ANON_6_httpwww_litle_comschemaauthDate', False)
    ...
    __fraudResult = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'fraudResult'), 'fraudResult', '__httpwww_litle_comschema_CTD_ANON_6_httpwww_litle_comschemafraudResult', False)
    ...
    __authCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authCode'), 'authCode', '__httpwww_litle_comschema_CTD_ANON_6_httpwww_litle_comschemaauthCode', False)
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __cardProductType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardProductType'), 'cardProductType', '__httpwww_litle_comschema_CTD_ANON_8_httpwww_litle_comschemacardProductType', False)
    ...
    __fundingSource = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'fundingSource'), 'fundingSource', '__httpwww_litle_comschema_CTD_ANON_8_httpwww_litle_comschemafundingSource', False)
    ...
    __affluence = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'affluence'), 'affluence', '__httpwww_litle_comschema_CTD_ANON_8_httpwww_litle_comschemaaffluence', False)
    ...
    __issuerCountry = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'issuerCountry'), 'issuerCountry', '__httpwww_litle_comschema_CTD_ANON_8_httpwww_litle_comschemaissuerCountry', False)
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __dentalAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'dentalAmount'), 'dentalAmount', '__httpwww_litle_comschema_CTD_ANON_9_httpwww_litle_comschemadentalAmount', False)
    ...
    __totalHealthcareAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'totalHealthcareAmount'), 'totalHealthcareAmount', '__httpwww_litle_comschema_CTD_ANON_9_httpwww_litle_comschematotalHealthcareAmount', False)
    ...
    __RxAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RxAmount'), 'RxAmount', '__httpwww_litle_comschema_CTD_ANON_9_httpwww_litle_comschemaRxAmount', False)
    ...
    __visionAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'visionAmount'), 'visionAmount', '__httpwww_litle_comschema_CTD_ANON_9_httpwww_litle_comschemavisionAmount', False)
    ...
    __clinicOtherAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'clinicOtherAmount'), 'clinicOtherAmount', '__httpwww_litle_comschema_CTD_ANON_9_httpwww_litle_comschemaclinicOtherAmount', False)
...
class CTD_ANON_10 (transactionTypeWithReportGroupAndPartial):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = None
    ...
    __processingInstructions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), 'processingInstructions', '__httpwww_litle_comschema_CTD_ANON_10_httpwww_litle_comschemaprocessingInstructions', False)
    ...
    __payPalNotes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), 'payPalNotes', '__httpwww_litle_comschema_CTD_ANON_10_httpwww_litle_comschemapayPalNotes', False)
    ...
    __payPalOrderComplete = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete'), 'payPalOrderComplete', '__httpwww_litle_comschema_CTD_ANON_10_httpwww_litle_comschemapayPalOrderComplete', False)
    ...
    __enhancedData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), 'enhancedData', '__httpwww_litle_comschema_CTD_ANON_10_httpwww_litle_comschemaenhancedData', False)
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __descriptor = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'descriptor'), 'descriptor', '__httpwww_litle_comschema_CTD_ANON_11_httpwww_litle_comschemadescriptor', False)
    ...
    __phone = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'phone'), 'phone', '__httpwww_litle_comschema_CTD_ANON_11_httpwww_litle_comschemaphone', False)
    ...
    __url = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'url'), 'url', '__httpwww_litle_comschema_CTD_ANON_11_httpwww_litle_comschemaurl', False)
    ...
    __city = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'city'), 'city', '__httpwww_litle_comschema_CTD_ANON_11_httpwww_litle_comschemacity', False)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __cardAcceptorTaxId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardAcceptorTaxId'), 'cardAcceptorTaxId', '__httpwww_litle_comschema_CTD_ANON_13_httpwww_litle_comschemacardAcceptorTaxId', False)
    ...
    __taxIncludedInTotal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxIncludedInTotal'), 'taxIncludedInTotal', '__httpwww_litle_comschema_CTD_ANON_13_httpwww_litle_comschemataxIncludedInTotal', False)
    ...
    __taxRate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxRate'), 'taxRate', '__httpwww_litle_comschema_CTD_ANON_13_httpwww_litle_comschemataxRate', False)
    ...
    __taxTypeIdentifier = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxTypeIdentifier'), 'taxTypeIdentifier', '__httpwww_litle_comschema_CTD_ANON_13_httpwww_litle_comschemataxTypeIdentifier', False)
...
class CTD_ANON_14 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ssn = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ssn'), 'ssn', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemassn', False)
    ...
    __incomeCurrency = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'incomeCurrency'), 'incomeCurrency', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemaincomeCurrency', False)
    ...
    __dob = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'dob'), 'dob', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemadob', False)
    ...
    __customerType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerType'), 'customerType', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemacustomerType', False)
    ...
    __customerRegistrationDate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerRegistrationDate'), 'customerRegistrationDate', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemacustomerRegistrationDate', False)
    ...
    __customerSavingAccount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerSavingAccount'), 'customerSavingAccount', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemacustomerSavingAccount', False)
    ...
    __residenceStatus = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'residenceStatus'), 'residenceStatus', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemaresidenceStatus', False)
    ...
    __customerCheckingAccount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerCheckingAccount'), 'customerCheckingAccount', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemacustomerCheckingAccount', False)
    ...
    __yearsAtEmployer = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'yearsAtEmployer'), 'yearsAtEmployer', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemayearsAtEmployer', False)
    ...
    __employerName = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'employerName'), 'employerName', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemaemployerName', False)
    ...
    __yearsAtResidence = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'yearsAtResidence'), 'yearsAtResidence', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemayearsAtResidence', False)
    ...
    __customerWorkTelephone = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerWorkTelephone'), 'customerWorkTelephone', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemacustomerWorkTelephone', False)
    ...
    __incomeAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'incomeAmount'), 'incomeAmount', '__httpwww_litle_comschema_CTD_ANON_14_httpwww_litle_comschemaincomeAmount', False)
...
class CTD_ANON_15 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __authorizationSourcePlatform = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authorizationSourcePlatform'), 'authorizationSourcePlatform', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemaauthorizationSourcePlatform', False)
    ...
    __bmlMerchantId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId'), 'bmlMerchantId', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemabmlMerchantId', False)
    ...
    __secretQuestionAnswer = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionAnswer'), 'secretQuestionAnswer', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemasecretQuestionAnswer', False)
    ...
    __preapprovalNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'preapprovalNumber'), 'preapprovalNumber', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemapreapprovalNumber', False)
    ...
    __bmlProductType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'bmlProductType'), 'bmlProductType', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemabmlProductType', False)
    ...
    __customerPasswordChanged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerPasswordChanged'), 'customerPasswordChanged', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemacustomerPasswordChanged', False)
    ...
    __merchantPromotionalCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'merchantPromotionalCode'), 'merchantPromotionalCode', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemamerchantPromotionalCode', False)
    ...
    __customerBillingAddressChanged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerBillingAddressChanged'), 'customerBillingAddressChanged', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemacustomerBillingAddressChanged', False)
    ...
    __virtualAuthenticationKeyData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'virtualAuthenticationKeyData'), 'virtualAuthenticationKeyData', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemavirtualAuthenticationKeyData', False)
    ...
    __customerEmailChanged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerEmailChanged'), 'customerEmailChanged', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemacustomerEmailChanged', False)
    ...
    __itemCategoryCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'itemCategoryCode'), 'itemCategoryCode', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemaitemCategoryCode', False)
    ...
    __customerPhoneChanged = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerPhoneChanged'), 'customerPhoneChanged', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemacustomerPhoneChanged', False)
    ...
    __secretQuestionCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionCode'), 'secretQuestionCode', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschemasecretQuestionCode', False)
    ...
    __termsAndConditions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'termsAndConditions'), 'termsAndConditions', '__httpwww_litle_comschema_CTD_ANON_15_httpwww_litle_comschematermsAndConditions', False)
...
class CTD_ANON_16 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __newCardInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'newCardInfo'), 'newCardInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemanewCardInfo', False)
    ...
    __originalAccountInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'originalAccountInfo'), 'originalAccountInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemaoriginalAccountInfo', False)
    ...
    __extendedCardResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'extendedCardResponse'), 'extendedCardResponse', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemaextendedCardResponse', False)
    ...
    __originalCardTokenInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'originalCardTokenInfo'), 'originalCardTokenInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemaoriginalCardTokenInfo', False)
    ...
    __newAccountInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'newAccountInfo'), 'newAccountInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemanewAccountInfo', False)
    ...
    __newCardTokenInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'newCardTokenInfo'), 'newCardTokenInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemanewCardTokenInfo', False)
    ...
    __newTokenInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'newTokenInfo'), 'newTokenInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemanewTokenInfo', False)
    ...
    __originalTokenInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'originalTokenInfo'), 'originalTokenInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemaoriginalTokenInfo', False)
    ...
    __originalCardInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'originalCardInfo'), 'originalCardInfo', '__httpwww_litle_comschema_CTD_ANON_16_httpwww_litle_comschemaoriginalCardInfo', False)
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __creditLine = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'creditLine'), 'creditLine', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemacreditLine', False)
    ...
    __addressIndicator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'addressIndicator'), 'addressIndicator', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemaaddressIndicator', False)
    ...
    __loanToValueEstimator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'loanToValueEstimator'), 'loanToValueEstimator', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemaloanToValueEstimator', False)
    ...
    # Element {http://www.litle.com/schema}bmlMerchantId uses Python identifier bmlMerchantId
    __bmlMerchantId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId'), 'bmlMerchantId', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemabmlMerchantId', False)
    ...
    __promotionalOfferCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'promotionalOfferCode'), 'promotionalOfferCode', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemapromotionalOfferCode', False)
    ...
    __riskEstimator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'riskEstimator'), 'riskEstimator', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemariskEstimator', False)
    ...
    __approvedTermsCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'approvedTermsCode'), 'approvedTermsCode', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemaapprovedTermsCode', False)
    ...
    __riskQueueAssignment = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'riskQueueAssignment'), 'riskQueueAssignment', '__httpwww_litle_comschema_CTD_ANON_17_httpwww_litle_comschemariskQueueAssignment', False)
...
class CTD_ANON_18 (transactionTypeWithReportGroup):
    ...
    __authInformation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authInformation'), 'authInformation', '__httpwww_litle_comschema_CTD_ANON_18_httpwww_litle_comschemaauthInformation', False)
    ...
    __shipToAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress'), 'shipToAddress', '__httpwww_litle_comschema_CTD_ANON_18_httpwww_litle_comschemashipToAddress', False)
...
class CTD_ANON_19 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}orderSource uses Python identifier orderSource
    __orderSource = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'orderSource'), 'orderSource', '__httpwww_litle_comschema_CTD_ANON_19_httpwww_litle_comschemaorderSource', False)
    ...
    # Element {http://www.litle.com/schema}billToAddress uses Python identifier billToAddress
    __billToAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'billToAddress'), 'billToAddress', '__httpwww_litle_comschema_CTD_ANON_19_httpwww_litle_comschemabillToAddress', False)
    ...
    # Element {http://www.litle.com/schema}amount uses Python identifier amount
    __amount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'amount'), 'amount', '__httpwww_litle_comschema_CTD_ANON_19_httpwww_litle_comschemaamount', False)
    ...
    __echeckOrEcheckToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), 'echeckOrEcheckToken', '__httpwww_litle_comschema_CTD_ANON_19_httpwww_litle_comschemaecheckOrEcheckToken', False)
...
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __cardholderId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardholderId'), 'cardholderId', '__httpwww_litle_comschema_CTD_ANON_20_httpwww_litle_comschemacardholderId', False)
    ...
    __capability = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'capability'), 'capability', '__httpwww_litle_comschema_CTD_ANON_20_httpwww_litle_comschemacapability', False)
    ...
    __entryMode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'entryMode'), 'entryMode', '__httpwww_litle_comschema_CTD_ANON_20_httpwww_litle_comschemaentryMode', False)
...
class CTD_ANON_21 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}payPalNotes uses Python identifier payPalNotes
    __payPalNotes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), 'payPalNotes', '__httpwww_litle_comschema_CTD_ANON_21_httpwww_litle_comschemapayPalNotes', False)
...
class CTD_ANON_22 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}accountUpdater uses Python identifier accountUpdater
    __accountUpdater = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), 'accountUpdater', '__httpwww_litle_comschema_CTD_ANON_22_httpwww_litle_comschemaaccountUpdater', False)
    ...
    # Element {http://www.litle.com/schema}tokenResponse uses Python identifier tokenResponse
    __tokenResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), 'tokenResponse', '__httpwww_litle_comschema_CTD_ANON_22_httpwww_litle_comschematokenResponse', False)
...
class CTD_ANON_26 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}fraudResult uses Python identifier fraudResult
    __fraudResult = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'fraudResult'), 'fraudResult', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemafraudResult', False)
    ...
    __billMeLaterResponseData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData'), 'billMeLaterResponseData', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemabillMeLaterResponseData', False)
    ...
    __authorizationResponseSubCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode'), 'authorizationResponseSubCode', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemaauthorizationResponseSubCode', False)
    ...
    __cardProductId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardProductId'), 'cardProductId', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemacardProductId', False)
    ...
    __approvedAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount'), 'approvedAmount', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemaapprovedAmount', False)
    ...
    # Element {http://www.litle.com/schema}authCode uses Python identifier authCode
    __authCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authCode'), 'authCode', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemaauthCode', False)
    ...
    __recycling = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'recycling'), 'recycling', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemarecycling', False)
    ...
    __enhancedAuthResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse'), 'enhancedAuthResponse', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemaenhancedAuthResponse', False)
    ...
    __accountInformation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'accountInformation'), 'accountInformation', '__httpwww_litle_comschema_CTD_ANON_26_httpwww_litle_comschemaaccountInformation', False)
...
class CTD_ANON_27 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}cardProductId uses Python identifier cardProductId
    __cardProductId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardProductId'), 'cardProductId', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemacardProductId', False)
    ...
    # Element {http://www.litle.com/schema}authCode uses Python identifier authCode
    __authCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authCode'), 'authCode', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaauthCode', False)
    ...
    # Element {http://www.litle.com/schema}accountInformation uses Python identifier accountInformation
    __accountInformation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'accountInformation'), 'accountInformation', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaaccountInformation', False)
    ...
    # Element {http://www.litle.com/schema}accountUpdater uses Python identifier accountUpdater
    __accountUpdater = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), 'accountUpdater', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaaccountUpdater', False)
    ...
    # Element {http://www.litle.com/schema}authorizationResponseSubCode uses Python identifier authorizationResponseSubCode
    __authorizationResponseSubCode = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode'), 'authorizationResponseSubCode', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaauthorizationResponseSubCode', False)
    ...
    # Element {http://www.litle.com/schema}enhancedAuthResponse uses Python identifier enhancedAuthResponse
    __enhancedAuthResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse'), 'enhancedAuthResponse', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaenhancedAuthResponse', False)
    ...
    # Element {http://www.litle.com/schema}approvedAmount uses Python identifier approvedAmount
    __approvedAmount = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount'), 'approvedAmount', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemaapprovedAmount', False)
    ...
    # Element {http://www.litle.com/schema}recycling uses Python identifier recycling
    __recycling = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'recycling'), 'recycling', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemarecycling', False)
    ...
    # Element {http://www.litle.com/schema}billMeLaterResponseData uses Python identifier billMeLaterResponseData
    __billMeLaterResponseData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData'), 'billMeLaterResponseData', '__httpwww_litle_comschema_CTD_ANON_27_httpwww_litle_comschemabillMeLaterResponseData', False)
...
class CTD_ANON_29 (transactionTypeWithReportGroup):
    ...
    __actionReason = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'actionReason'), 'actionReason', '__httpwww_litle_comschema_CTD_ANON_29_httpwww_litle_comschemaactionReason', False)
    ...
    # Element {http://www.litle.com/schema}payPalNotes uses Python identifier payPalNotes
    __payPalNotes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), 'payPalNotes', '__httpwww_litle_comschema_CTD_ANON_29_httpwww_litle_comschemapayPalNotes', False)
...
class CTD_ANON_30 (transactionTypeWithReportGroup):
    ...
    # Attribute duplicate uses Python identifier duplicate
    __duplicate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'duplicate'), 'duplicate', '__httpwww_litle_comschema_CTD_ANON_30_duplicate', pyxb.binding.datatypes.boolean)
...
class CTD_ANON_31 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}bin uses Python identifier bin
    __bin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'bin'), 'bin', '__httpwww_litle_comschema_CTD_ANON_31_httpwww_litle_comschemabin', False)
    ...
    # Element {http://www.litle.com/schema}eCheckAccountSuffix uses Python identifier eCheckAccountSuffix
    __eCheckAccountSuffix = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'eCheckAccountSuffix'), 'eCheckAccountSuffix', '__httpwww_litle_comschema_CTD_ANON_31_httpwww_litle_comschemaeCheckAccountSuffix', False)
    ...
    # Element {http://www.litle.com/schema}type uses Python identifier type
    __type = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'type'), 'type', '__httpwww_litle_comschema_CTD_ANON_31_httpwww_litle_comschematype', False)
    ...
    # Element {http://www.litle.com/schema}litleToken uses Python identifier litleToken
    __litleToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'litleToken'), 'litleToken', '__httpwww_litle_comschema_CTD_ANON_31_httpwww_litle_comschemalitleToken', False)
...
class CTD_ANON_32 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}tokenResponse uses Python identifier tokenResponse
    __tokenResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), 'tokenResponse', '__httpwww_litle_comschema_CTD_ANON_32_httpwww_litle_comschematokenResponse', False)
...
class CTD_ANON_34 (baseRequest):
    ...
    __merchantId = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'merchantId'), 'merchantId', '__httpwww_litle_comschema_CTD_ANON_34_merchantId', merchantIdentificationType, required=True)
...
class CTD_ANON_36 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}filtering uses Python identifier filtering
    __filtering = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'filtering'), 'filtering', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemafiltering', False)
    ...
    # Element {http://www.litle.com/schema}processingInstructions uses Python identifier processingInstructions
    __processingInstructions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), 'processingInstructions', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemaprocessingInstructions', False)
    ...
    # Element {http://www.litle.com/schema}amexAggregatorData uses Python identifier amexAggregatorData
    __amexAggregatorData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData'), 'amexAggregatorData', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemaamexAggregatorData', False)
    ...
    # Element {http://www.litle.com/schema}healthcareIIAS uses Python identifier healthcareIIAS
    __healthcareIIAS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'healthcareIIAS'), 'healthcareIIAS', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemahealthcareIIAS', False)
    ...
    # Element {http://www.litle.com/schema}recyclingRequest uses Python identifier recyclingRequest
    __recyclingRequest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'recyclingRequest'), 'recyclingRequest', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemarecyclingRequest', False)
    ...
    # Element {http://www.litle.com/schema}paypal uses Python identifier paypal
    __paypal = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'paypal'), 'paypal', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemapaypal', False)
    ...
    # Element {http://www.litle.com/schema}token uses Python identifier token
    __token = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'token'), 'token', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschematoken', False)
    ...
    # Element {http://www.litle.com/schema}paypage uses Python identifier paypage
    __paypage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'paypage'), 'paypage', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemapaypage', False)
    ...
    # Element {http://www.litle.com/schema}customerInfo uses Python identifier customerInfo
    __customerInfo = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customerInfo'), 'customerInfo', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemacustomerInfo', False)
    ...
    __fraudCheck = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'fraudCheck'), 'fraudCheck', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemafraudCheck', False)
    ...
    # Element {http://www.litle.com/schema}pos uses Python identifier pos
    __pos = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'pos'), 'pos', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemapos', False)
    ...
    # Element {http://www.litle.com/schema}cardholderAuthentication uses Python identifier cardholderAuthentication
    __cardholderAuthentication = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'cardholderAuthentication'), 'cardholderAuthentication', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemacardholderAuthentication', False)
    ...
    # Element {http://www.litle.com/schema}enhancedData uses Python identifier enhancedData
    __enhancedData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), 'enhancedData', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemaenhancedData', False)
    ...
    # Element {http://www.litle.com/schema}taxType uses Python identifier taxType
    __taxType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'taxType'), 'taxType', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemataxType', False)
    ...
    # Element {http://www.litle.com/schema}billMeLaterRequest uses Python identifier billMeLaterRequest
    __billMeLaterRequest = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), 'billMeLaterRequest', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemabillMeLaterRequest', False)
    ...
    # Element {http://www.litle.com/schema}payPalOrderComplete uses Python identifier payPalOrderComplete
    __payPalOrderComplete = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete'), 'payPalOrderComplete', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemapayPalOrderComplete', False)
    ...
    # Element {http://www.litle.com/schema}payPalNotes uses Python identifier payPalNotes
    __payPalNotes = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), 'payPalNotes', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemapayPalNotes', False)
    ...
    # Element {http://www.litle.com/schema}allowPartialAuth uses Python identifier allowPartialAuth
    __allowPartialAuth = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'allowPartialAuth'), 'allowPartialAuth', '__httpwww_litle_comschema_CTD_ANON_36_httpwww_litle_comschemaallowPartialAuth', False)
...
class CTD_ANON_37 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}tokenResponse uses Python identifier tokenResponse
    __tokenResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), 'tokenResponse', '__httpwww_litle_comschema_CTD_ANON_37_httpwww_litle_comschematokenResponse', False)
...
class CTD_ANON_38 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __transactionResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'transactionResponse'), 'transactionResponse', '__httpwww_litle_comschema_CTD_ANON_38_httpwww_litle_comschematransactionResponse', False)
    ...
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_litle_comschema_CTD_ANON_38_version', versionType, required=True)
...
class CTD_ANON_39 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}echeckOrEcheckToken uses Python identifier echeckOrEcheckToken
    __echeckOrEcheckToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), 'echeckOrEcheckToken', '__httpwww_litle_comschema_CTD_ANON_39_httpwww_litle_comschemaecheckOrEcheckToken', False)
...
class CTD_ANON_40 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __prepaidCardType = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'prepaidCardType'), 'prepaidCardType', '__httpwww_litle_comschema_CTD_ANON_40_httpwww_litle_comschemaprepaidCardType', False)
    ...
    # Element {http://www.litle.com/schema}type uses Python identifier type
    __type = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'type'), 'type', '__httpwww_litle_comschema_CTD_ANON_40_httpwww_litle_comschematype', False)
    ...
    __reloadable = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'reloadable'), 'reloadable', '__httpwww_litle_comschema_CTD_ANON_40_httpwww_litle_comschemareloadable', False)
    ...
    __availableBalance = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'availableBalance'), 'availableBalance', '__httpwww_litle_comschema_CTD_ANON_40_httpwww_litle_comschemaavailableBalance', False)
...
class CTD_ANON_41 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __IIASFlag = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IIASFlag'), 'IIASFlag', '__httpwww_litle_comschema_CTD_ANON_41_httpwww_litle_comschemaIIASFlag', False)
    ...
    __healthcareAmounts = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'healthcareAmounts'), 'healthcareAmounts', '__httpwww_litle_comschema_CTD_ANON_41_httpwww_litle_comschemahealthcareAmounts', False)
...
class CTD_ANON_42 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}processingInstructions uses Python identifier processingInstructions
    __processingInstructions = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), 'processingInstructions', '__httpwww_litle_comschema_CTD_ANON_42_httpwww_litle_comschemaprocessingInstructions', False)
...
class CTD_ANON_43 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.litle.com/schema}payerId uses Python identifier payerId
    __payerId = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payerId'), 'payerId', '__httpwww_litle_comschema_CTD_ANON_43_httpwww_litle_comschemapayerId', False)
    ...
    __payerEmail = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'payerEmail'), 'payerEmail', '__httpwww_litle_comschema_CTD_ANON_43_httpwww_litle_comschemapayerEmail', False)
...
class CTD_ANON_44 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}echeckOrEcheckToken uses Python identifier echeckOrEcheckToken
    __echeckOrEcheckToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), 'echeckOrEcheckToken', '__httpwww_litle_comschema_CTD_ANON_44_httpwww_litle_comschemaecheckOrEcheckToken', False)
...
class CTD_ANON_45 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}shipToAddress uses Python identifier shipToAddress
    __shipToAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress'), 'shipToAddress', '__httpwww_litle_comschema_CTD_ANON_45_httpwww_litle_comschemashipToAddress', False)
    ...
    # Element {http://www.litle.com/schema}customBilling uses Python identifier customBilling
    __customBilling = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), 'customBilling', '__httpwww_litle_comschema_CTD_ANON_45_httpwww_litle_comschemacustomBilling', False)
    ...
    # Element {http://www.litle.com/schema}merchantData uses Python identifier merchantData
    __merchantData = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'merchantData'), 'merchantData', '__httpwww_litle_comschema_CTD_ANON_45_httpwww_litle_comschemamerchantData', False)
    ...
    __verify = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'verify'), 'verify', '__httpwww_litle_comschema_CTD_ANON_45_httpwww_litle_comschemaverify', False)
...
class CTD_ANON_46 (transactionTypeWithReportGroup):
    ...
    # Element {http://www.litle.com/schema}accountUpdater uses Python identifier accountUpdater
    __accountUpdater = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), 'accountUpdater', '__httpwww_litle_comschema_CTD_ANON_46_httpwww_litle_comschemaaccountUpdater', False)
...
echeckVerificationResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckVerificationResponse'), CTD_ANON)
...
enhancedAuthResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse'), CTD_ANON_8)
Namespace.addCategoryObject('elementBinding', enhancedAuthResponse.name().localName(), enhancedAuthResponse)

capture = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'capture'), CTD_ANON_10)
...
detailTax = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'detailTax'), CTD_ANON_13)
Namespace.addCategoryObject('elementBinding', detailTax.name().localName(), detailTax)

customerInfo = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerInfo'), CTD_ANON_14)
Namespace.addCategoryObject('elementBinding', customerInfo.name().localName(), customerInfo)

captureGivenAuth = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'captureGivenAuth'), CTD_ANON_18)
...
accountUpdater = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16)
...
echeckVerification = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckVerification'), CTD_ANON_19)
Namespace.addCategoryObject('elementBinding', echeckVerification.name().localName(), echeckVerification)

credit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'credit'), CTD_ANON_21)
Namespace.addCategoryObject('elementBinding', credit.name().localName(), credit)

echeckRedepositResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckRedepositResponse'), CTD_ANON_22)
Namespace.addCategoryObject('elementBinding', echeckRedepositResponse.name().localName(), echeckRedepositResponse)

captureResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'captureResponse'), CTD_ANON_23)
Namespace.addCategoryObject('elementBinding', captureResponse.name().localName(), captureResponse)

echeckVoid = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckVoid'), CTD_ANON_24)
Namespace.addCategoryObject('elementBinding', echeckVoid.name().localName(), echeckVoid)

authReversalResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authReversalResponse'), CTD_ANON_25)
Namespace.addCategoryObject('elementBinding', authReversalResponse.name().localName(), authReversalResponse)

saleResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'saleResponse'), CTD_ANON_26)
Namespace.addCategoryObject('elementBinding', saleResponse.name().localName(), saleResponse)

authorizationResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponse'), CTD_ANON_27)
...
enhancedData = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3)
Namespace.addCategoryObject('elementBinding', enhancedData.name().localName(), enhancedData)

authorization = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authorization'), CTD_ANON_28)
Namespace.addCategoryObject('elementBinding', authorization.name().localName(), authorization)

authReversal = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authReversal'), CTD_ANON_29)
Namespace.addCategoryObject('elementBinding', authReversal.name().localName(), authReversal)

voidResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'voidResponse'), CTD_ANON_30)
Namespace.addCategoryObject('elementBinding', voidResponse.name().localName(), voidResponse)

registerTokenResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'registerTokenResponse'), CTD_ANON_31)
Namespace.addCategoryObject('elementBinding', registerTokenResponse.name().localName(), registerTokenResponse)

creditResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'creditResponse'), CTD_ANON_32)
...
customBilling = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11)
...
authentication = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authentication'), CTD_ANON_5)
Namespace.addCategoryObject('elementBinding', authentication.name().localName(), authentication)

billMeLaterRequest = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), CTD_ANON_15)
Namespace.addCategoryObject('elementBinding', billMeLaterRequest.name().localName(), billMeLaterRequest)

litleOnlineRequest = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'litleOnlineRequest'), CTD_ANON_34)
Namespace.addCategoryObject('elementBinding', litleOnlineRequest.name().localName(), litleOnlineRequest)

forceCapture = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'forceCapture'), CTD_ANON_35)
Namespace.addCategoryObject('elementBinding', forceCapture.name().localName(), forceCapture)

sale = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sale'), CTD_ANON_36)
Namespace.addCategoryObject('elementBinding', sale.name().localName(), sale)

captureGivenAuthResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'captureGivenAuthResponse'), CTD_ANON_37)
Namespace.addCategoryObject('elementBinding', captureGivenAuthResponse.name().localName(), captureGivenAuthResponse)

litleOnlineResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'litleOnlineResponse'), CTD_ANON_38)
Namespace.addCategoryObject('elementBinding', litleOnlineResponse.name().localName(), litleOnlineResponse)

authInformation = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authInformation'), CTD_ANON_6)
...
echeckRedeposit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckRedeposit'), CTD_ANON_39)
...
lineItemData = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lineItemData'), CTD_ANON_2)
...
void = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'void'), CTD_ANON_42)
...
healthcareAmounts = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'healthcareAmounts'), CTD_ANON_9)
Namespace.addCategoryObject('elementBinding', healthcareAmounts.name().localName(), healthcareAmounts)

echeckCredit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckCredit'), CTD_ANON_44)
Namespace.addCategoryObject('elementBinding', echeckCredit.name().localName(), echeckCredit)

healthcareIIAS = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'healthcareIIAS'), CTD_ANON_41)
Namespace.addCategoryObject('elementBinding', healthcareIIAS.name().localName(), healthcareIIAS)

echeckSale = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckSale'), CTD_ANON_45)
Namespace.addCategoryObject('elementBinding', echeckSale.name().localName(), echeckSale)

billMeLaterResponseData = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData'), CTD_ANON_17)
Namespace.addCategoryObject('elementBinding', billMeLaterResponseData.name().localName(), billMeLaterResponseData)

pos = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20)
Namespace.addCategoryObject('elementBinding', pos.name().localName(), pos)

forceCaptureResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'forceCaptureResponse'), CTD_ANON_46)
Namespace.addCategoryObject('elementBinding', forceCaptureResponse.name().localName(), forceCaptureResponse)

echeckVoidResponse = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckVoidResponse'), CTD_ANON_47)
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), tokenResponseType, scope=CTD_ANON))
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'postDate'), pyxb.binding.datatypes.date, scope=CTD_ANON))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'response'), responseType, scope=CTD_ANON))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'responseTime'), pyxb.binding.datatypes.dateTime, scope=CTD_ANON))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'message'), messageType, scope=CTD_ANON))
CTD_ANON._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'response')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'responseTime')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'message')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'postDate')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'itemDiscountAmount'), transactionAmountType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'quantity'), quantityType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'detailTax'), CTD_ANON_13, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'unitCost'), unitCostType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxAmount'), transactionAmountType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commodityCode'), commodityCodeType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'itemSequenceNumber'), itemSequenceNumberType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotal'), transactionAmountType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'itemDescription'), itemDescriptionType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotalWithTax'), transactionAmountType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'productCode'), productCodeType, scope=CTD_ANON_2))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'unitOfMeasure'), unitOfMeasureType, scope=CTD_ANON_2))
CTD_ANON_2._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'itemSequenceNumber')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'itemDescription')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'productCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'quantity')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'unitOfMeasure')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotal')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lineItemTotalWithTax')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'itemDiscountAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commodityCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'unitCost')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'detailTax')), min_occurs=0L, max_occurs=6L)
    )
CTD_ANON_2._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_2._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'invoiceReferenceNumber'), invoiceReferenceNumberType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'shippingAmount'), transactionAmountType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'orderDate'), pyxb.binding.datatypes.date, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dutyAmount'), transactionAmountType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lineItemData'), CTD_ANON_2, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'deliveryType'), STD_ANON_9, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerReference'), customerReferenceType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'destinationPostalCode'), zipType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'shipFromPostalCode'), zipType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxExempt'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'salesTax'), transactionAmountType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'destinationCountryCode'), countryTypeEnum, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'discountAmount'), transactionAmountType, scope=CTD_ANON_3))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'detailTax'), CTD_ANON_13, scope=CTD_ANON_3))
CTD_ANON_3._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerReference')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'salesTax')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'deliveryType')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxExempt')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'discountAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shippingAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dutyAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shipFromPostalCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'destinationPostalCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'destinationCountryCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'invoiceReferenceNumber')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orderDate')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'detailTax')), min_occurs=0L, max_occurs=6L),
    pyxb.binding.content.ParticleModel(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lineItemData')), min_occurs=0L, max_occurs=99L)
    )
...
CTD_ANON_4._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sellerId')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sellerMerchantCategoryCode')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_4._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_4._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'password'), string20Type, scope=CTD_ANON_5))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'user'), string20Type, scope=CTD_ANON_5))
CTD_ANON_5._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'user')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'password')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_5._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_5._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authAmount'), transactionAmountType, scope=CTD_ANON_6))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authDate'), pyxb.binding.datatypes.date, scope=CTD_ANON_6))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fraudResult'), CTD_ANON_7, scope=CTD_ANON_6))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authCode'), authCodeType, scope=CTD_ANON_6))
CTD_ANON_6._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authDate')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fraudResult')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authAmount')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardProductType'), cardProductTypeEnum, scope=CTD_ANON_8))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fundingSource'), CTD_ANON_40, scope=CTD_ANON_8))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'affluence'), affluenceTypeEnum, scope=CTD_ANON_8))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'issuerCountry'), string3Type, scope=CTD_ANON_8))
CTD_ANON_8._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fundingSource')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'affluence')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'issuerCountry')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardProductType')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_8._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_8._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dentalAmount'), transactionAmountType, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'totalHealthcareAmount'), transactionAmountType, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RxAmount'), transactionAmountType, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'visionAmount'), transactionAmountType, scope=CTD_ANON_9))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'clinicOtherAmount'), transactionAmountType, scope=CTD_ANON_9))
CTD_ANON_9._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'totalHealthcareAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RxAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'visionAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'clinicOtherAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dentalAmount')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_9._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_9._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), CTD_ANON_, scope=CTD_ANON_10))
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), payPalNotesType, scope=CTD_ANON_10))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_10))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_10))
CTD_ANON_10._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'enhancedData')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_10._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_10._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'descriptor'), descriptorType, scope=CTD_ANON_11))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'phone'), customBillingPhoneType, scope=CTD_ANON_11))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'url'), customBillingUrlType, scope=CTD_ANON_11))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'city'), customBillingCityType, scope=CTD_ANON_11))
CTD_ANON_11._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'phone')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'city')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'url')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_11._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'descriptor')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_12))
...
contact._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'email'), STD_ANON_6, scope=contact))
...
CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardAcceptorTaxId'), cardAcceptorTaxIdType, scope=CTD_ANON_13))

CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxIncludedInTotal'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_13))
...
CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxRate'), taxRateType, scope=CTD_ANON_13))

CTD_ANON_13._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxTypeIdentifier'), taxTypeIdentifierEnum, scope=CTD_ANON_13))
CTD_ANON_13._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxIncludedInTotal')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxRate')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxTypeIdentifier')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardAcceptorTaxId')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ssn'), STD_ANON_11, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'incomeCurrency'), currencyCodeEnum, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dob'), pyxb.binding.datatypes.date, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerType'), STD_ANON, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerRegistrationDate'), pyxb.binding.datatypes.date, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerSavingAccount'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'residenceStatus'), STD_ANON_12, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerCheckingAccount'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'yearsAtEmployer'), STD_ANON_10, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'employerName'), string20Type, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'yearsAtResidence'), STD_ANON_8, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerWorkTelephone'), phoneType, scope=CTD_ANON_14))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'incomeAmount'), pyxb.binding.datatypes.long, scope=CTD_ANON_14))
CTD_ANON_14._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ssn')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dob')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerRegistrationDate')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerType')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'incomeAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'incomeCurrency')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerCheckingAccount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerSavingAccount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'employerName')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerWorkTelephone')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'residenceStatus')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'yearsAtResidence')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'yearsAtEmployer')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_14._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_14._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authorizationSourcePlatform'), pyxb.binding.datatypes.string, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId'), litleIdType, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionAnswer'), string25Type, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'preapprovalNumber'), ccAccountNumberType, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bmlProductType'), STD_ANON_, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'virtualAuthenticationKeyPresenceIndicator'), virtualAuthenticationKeyPresenceIndicator, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerPasswordChanged'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'merchantPromotionalCode'), STD_ANON_4, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerBillingAddressChanged'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'virtualAuthenticationKeyData'), virtualAuthenticationKeyData, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerEmailChanged'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'itemCategoryCode'), STD_ANON_3, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerPhoneChanged'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionCode'), string2Type, scope=CTD_ANON_15))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'termsAndConditions'), STD_ANON_5, scope=CTD_ANON_15))
CTD_ANON_15._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bmlProductType')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'termsAndConditions')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'preapprovalNumber')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'merchantPromotionalCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerPasswordChanged')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerBillingAddressChanged')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerEmailChanged')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerPhoneChanged')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'secretQuestionAnswer')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'virtualAuthenticationKeyPresenceIndicator')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'virtualAuthenticationKeyData')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'itemCategoryCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authorizationSourcePlatform')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_15._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_15._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'newCardInfo'), cardAccountInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'originalAccountInfo'), echeckAccountInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'extendedCardResponse'), extendedCardResponseType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'originalCardTokenInfo'), cardTokenInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'newAccountInfo'), echeckAccountInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'newCardTokenInfo'), cardTokenInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'newTokenInfo'), echeckTokenInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'originalTokenInfo'), echeckTokenInfoType, scope=CTD_ANON_16))

CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'originalCardInfo'), cardAccountInfoType, scope=CTD_ANON_16))
CTD_ANON_16._GroupModel_ = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'originalAccountInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'newAccountInfo')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_16._GroupModel_2 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'originalTokenInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'newTokenInfo')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_16._GroupModel_3 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'originalCardInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'newCardInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extendedCardResponse')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_16._GroupModel_4 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'originalCardTokenInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'newCardTokenInfo')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extendedCardResponse')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_16._GroupModel = pyxb.binding.content.GroupChoice(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_16._GroupModel_2, min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._GroupModel_3, min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._GroupModel_4, min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extendedCardResponse')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'creditLine'), transactionAmountType, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'addressIndicator'), addressIndicator, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'loanToValueEstimator'), loanToValueEstimator, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId'), litleIdType, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'promotionalOfferCode'), pyxb.binding.datatypes.string, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'riskEstimator'), riskEstimator, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'approvedTermsCode'), STD_ANON_13, scope=CTD_ANON_17))

CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'riskQueueAssignment'), riskQueueAssignment, scope=CTD_ANON_17))
CTD_ANON_17._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bmlMerchantId')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'promotionalOfferCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'approvedTermsCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'creditLine')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'addressIndicator')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'loanToValueEstimator')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'riskEstimator')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'riskQueueAssignment')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_17._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_17._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authInformation'), CTD_ANON_6, scope=CTD_ANON_18))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress'), contact, scope=CTD_ANON_18))

CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), CTD_ANON_15, scope=CTD_ANON_18))

CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_18))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_18))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), CTD_ANON_, scope=CTD_ANON_18))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData'), CTD_ANON_4, scope=CTD_ANON_18))
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20, scope=CTD_ANON_18))
...
CTD_ANON_18._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authInformation')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress')), min_occurs=0L, max_occurs=1),
...
CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'orderSource'), orderSourceType, scope=CTD_ANON_19))

CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billToAddress'), contact, scope=CTD_ANON_19))

CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'amount'), transactionAmountType, scope=CTD_ANON_19))

CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), pyxb.binding.datatypes.anyType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_19))
...
CTD_ANON_19._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'litleTxnId')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'amount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'orderSource')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'billToAddress')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_19._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_19._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardholderId'), posCardholderIdTypeEnum, scope=CTD_ANON_20))

CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'capability'), posCapabilityTypeEnum, scope=CTD_ANON_20))

CTD_ANON_20._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'entryMode'), posEntryModeTypeEnum, scope=CTD_ANON_20))
CTD_ANON_20._GroupModel = pyxb.binding.content.GroupAll(
    pyxb.binding.content.ParticleModel(CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'capability')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'entryMode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardholderId')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_20._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_20._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20, scope=CTD_ANON_21))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), payPalNotesType, scope=CTD_ANON_21))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_21))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_21))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData'), CTD_ANON_4, scope=CTD_ANON_21))
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), CTD_ANON_15, scope=CTD_ANON_21))
...
CTD_ANON_21._GroupModel_3 = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_21._GroupModel_4, min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customBilling')), min_occurs=0L, max_occurs=1),
...
CTD_ANON_21._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_22._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_22))
...
CTD_ANON_22._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), tokenResponseType, scope=CTD_ANON_22))
...
CTD_ANON_22._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_22._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_22._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_23))
...
CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fraudResult'), CTD_ANON_7, scope=CTD_ANON_26))
...
CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData'), CTD_ANON_17, scope=CTD_ANON_26))
...
CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode'), pyxb.binding.datatypes.string, scope=CTD_ANON_26))
...
CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardProductId'), pyxb.binding.datatypes.string, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount'), transactionAmountType, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authCode'), authCodeType, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'recycling'), recyclingType, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse'), CTD_ANON_8, scope=CTD_ANON_26))

CTD_ANON_26._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountInformation'), accountInfoType, scope=CTD_ANON_26))
CTD_ANON_26._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardProductId')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'accountInformation')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fraudResult')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'recycling')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardProductId'), pyxb.binding.datatypes.string, scope=CTD_ANON_27))
...
CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authCode'), authCodeType, scope=CTD_ANON_27))

CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountInformation'), accountInfoType, scope=CTD_ANON_27))

CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_27))

CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode'), pyxb.binding.datatypes.string, scope=CTD_ANON_27))
...
CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse'), CTD_ANON_8, scope=CTD_ANON_27))

CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fraudResult'), CTD_ANON_7, scope=CTD_ANON_27))
...
CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount'), transactionAmountType, scope=CTD_ANON_27))
...
CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'recycling'), recyclingType, scope=CTD_ANON_27))

CTD_ANON_27._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData'), CTD_ANON_17, scope=CTD_ANON_27))
CTD_ANON_27._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardProductId')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authorizationResponseSubCode')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'approvedAmount')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'accountInformation')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterResponseData')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'enhancedAuthResponse')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_27._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'recycling')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerInfo'), CTD_ANON_14, scope=CTD_ANON_28))
...
CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), CTD_ANON_15, scope=CTD_ANON_28))
...
CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20, scope=CTD_ANON_28))
...
CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_28))
...
CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'healthcareIIAS'), CTD_ANON_41, scope=CTD_ANON_28))

CTD_ANON_28._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_28))
...
CTD_ANON_28._GroupModel_ = pyxb.binding.content.GroupSequence(
...
CTD_ANON_28._GroupModel_2 = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_28._GroupModel_3, min_occurs=0L, max_occurs=1),
...
CTD_ANON_28._GroupModel = pyxb.binding.content.GroupChoice(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_28._GroupModel_2, min_occurs=0L, max_occurs=1)
    )
CTD_ANON_28._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_28._GroupModel, min_occurs=1, max_occurs=1)



CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'actionReason'), actionReasonType, scope=CTD_ANON_29))
...
CTD_ANON_29._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), payPalNotesType, scope=CTD_ANON_29))
...
CTD_ANON_29._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_29._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_29._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'actionReason')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bin'), pyxb.binding.datatypes.string, scope=CTD_ANON_31))

CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'eCheckAccountSuffix'), pyxb.binding.datatypes.string, scope=CTD_ANON_31))
...
CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'type'), methodOfPaymentTypeEnum, scope=CTD_ANON_31))
...
CTD_ANON_31._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'litleToken'), ccAccountNumberType, scope=CTD_ANON_31))
CTD_ANON_31._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'litleToken')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bin')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'type')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_31._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'eCheckAccountSuffix')), min_occurs=0L, max_occurs=1),
...
CTD_ANON_32._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), tokenResponseType, scope=CTD_ANON_32))
...
CTD_ANON_32._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_32._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_33._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_33))
...
baseRequest._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'authentication'), CTD_ANON_5, scope=baseRequest))
...
CTD_ANON_34._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_34._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'authentication')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_34._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'transaction')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_35))

CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_35))

CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), CTD_ANON_, scope=CTD_ANON_35))
...
CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20, scope=CTD_ANON_35))
...
CTD_ANON_35._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData'), CTD_ANON_4, scope=CTD_ANON_35))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'filtering'), filteringType, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), CTD_ANON_, scope=CTD_ANON_36))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData'), CTD_ANON_4, scope=CTD_ANON_36))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'healthcareIIAS'), CTD_ANON_41, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'recyclingRequest'), recyclingRequestType, scope=CTD_ANON_36))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'paypal'), payPal, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'token'), cardTokenType, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'paypage'), cardPaypageType, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customerInfo'), CTD_ANON_14, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fraudCheck'), fraudCheckType, scope=CTD_ANON_36))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pos'), CTD_ANON_20, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cardholderAuthentication'), fraudCheckType, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'enhancedData'), CTD_ANON_3, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'taxType'), govtTaxTypeEnum, scope=CTD_ANON_36))
...
CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest'), CTD_ANON_15, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes'), payPalNotesType, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_36))

CTD_ANON_36._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'allowPartialAuth'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_36))
CTD_ANON_36._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'card')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'paypal')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'token')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'paypage')), min_occurs=1, max_occurs=1)
    )
CTD_ANON_36._GroupModel_2 = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fraudCheck')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cardholderAuthentication')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_36._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'litleTxnId')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customerInfo')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_36._GroupModel_, min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'billMeLaterRequest')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._GroupModel_2, min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'taxType')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'enhancedData')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'pos')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalOrderComplete')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payPalNotes')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'amexAggregatorData')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'allowPartialAuth')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'healthcareIIAS')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'filtering')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_36._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'recyclingRequest')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_37._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse'), tokenResponseType, scope=CTD_ANON_37))
...
CTD_ANON_37._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_37._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tokenResponse')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_37._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_37._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_38._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'transactionResponse'), transactionTypeWithReportGroup, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_38))
CTD_ANON_38._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_38._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'transactionResponse')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_39._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), pyxb.binding.datatypes.anyType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_39))
...
CTD_ANON_39._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_39._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken')), min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_40._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'prepaidCardType'), string50Type, scope=CTD_ANON_40))

CTD_ANON_40._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'type'), fundingSourceTypeEnum, scope=CTD_ANON_40))

CTD_ANON_40._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'reloadable'), string50Type, scope=CTD_ANON_40))

CTD_ANON_40._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'availableBalance'), string20Type, scope=CTD_ANON_40))
CTD_ANON_40._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_40._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'type')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_40._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'availableBalance')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_40._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'reloadable')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_40._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'prepaidCardType')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_40._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_40._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_41._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'IIASFlag'), IIASFlagType, scope=CTD_ANON_41))

CTD_ANON_41._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'healthcareAmounts'), CTD_ANON_9, scope=CTD_ANON_41))
CTD_ANON_41._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON_41._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'healthcareAmounts')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_41._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IIASFlag')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_41._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_41._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_42._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions'), CTD_ANON_, scope=CTD_ANON_42))
...
CTD_ANON_42._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_42._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'processingInstructions')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_42._ContentModel = pyxb.binding.content.ParticleModel(CTD_ANON_42._GroupModel, min_occurs=0L, max_occurs=1)



CTD_ANON_43._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payerId'), STD_ANON_7, scope=CTD_ANON_43))

CTD_ANON_43._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'payerEmail'), STD_ANON_2, scope=CTD_ANON_43))
CTD_ANON_43._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_43._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payerId')), min_occurs=1L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_43._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'payerEmail')), min_occurs=1L, max_occurs=1)
    )
...
CTD_ANON_44._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken'), pyxb.binding.datatypes.anyType, abstract=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_44))
...
CTD_ANON_44._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_44))
...
CTD_ANON_44._GroupModel_ = pyxb.binding.content.GroupSequence(
...
CTD_ANON_44._GroupModel_2 = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_44._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'echeckOrEcheckToken')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_44._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customBilling')), min_occurs=0L, max_occurs=1),
...
CTD_ANON_44._GroupModel = pyxb.binding.content.GroupChoice(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_44._GroupModel_2, min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_45._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress'), contact, scope=CTD_ANON_45))

CTD_ANON_45._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customBilling'), CTD_ANON_11, scope=CTD_ANON_45))
...
CTD_ANON_45._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'merchantData'), merchantDataType, scope=CTD_ANON_45))

CTD_ANON_45._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'verify'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_45))
CTD_ANON_45._GroupModel_ = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customBilling')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_45._GroupModel_2 = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'verify')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'amount')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shipToAddress')), min_occurs=0L, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customBilling')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_45._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'merchantData')), min_occurs=0L, max_occurs=1)
    )
CTD_ANON_45._GroupModel = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(CTD_ANON_45._GroupModel_, min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON_45._GroupModel_2, min_occurs=0L, max_occurs=1)
    )
...
CTD_ANON_46._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater'), CTD_ANON_16, scope=CTD_ANON_46))
...
CTD_ANON_46._GroupModel = pyxb.binding.content.GroupAll(
    ...
    pyxb.binding.content.ParticleModel(CTD_ANON_46._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'accountUpdater')), min_occurs=0L, max_occurs=1)
    )
